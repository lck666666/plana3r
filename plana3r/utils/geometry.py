...
from plana3r.utils.misc import invalid_to_zeros, invalid_to_nans
...
def depthmap_to_absolute_camera_coordinates(depthmap_resized, camera_intrinsics, camera_pose, **kw):
    """
    Args:
        - depthmap (HxW array):
        - camera_intrinsics: a 3x3 matrix
    ...
    Returns:
        pointmap of absolute coordinates (HxWx3 array), and a mask specifying valid pixels."""
    X_cam, valid_mask = depthmap_to_camera_coordinates(depthmap_resized, camera_intrinsics)
