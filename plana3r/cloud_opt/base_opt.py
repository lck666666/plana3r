...
from plana3r.utils.geometry import inv, geotrf
from plana3r.utils.device import to_numpy
from plana3r.utils.image import rgb
from plana3r.viz import SceneViz, segment_sky, auto_cam_size
from plana3r.optim_factory import adjust_learning_rate_by_lr

from plana3r.cloud_opt.commons import (edge_str, ALL_DISTS, NoGradParamDict, get_imshapes, signed_expm1, signed_log1p,
                                      cosine_schedule, linear_schedule, get_conf_trf)
import plana3r.cloud_opt.init_im_poses as init_fun
...
class BasePCOptimizer (nn.Module):
    ...
    def _check_edges(self):
        ...
        print("Expected indices:", list(range(len(indices))))
